...
if not is Expo project, please complete the installation [here](https://github.com/react-native-datetimepicker/datetimepicker/blob/master/docs/manual-installation.md)

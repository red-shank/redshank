...
| **bg**                  | `ThemeColor` `string`  | [ThemeColor](/docs/default-theme)                    | Change background color and set automatic color text in black or white | `primrary`                        |
| **color**               | `ThemeColor` `string`  | [ThemeColor](/docs/default-theme)                    | Change text color                                                      | `automatic`                       |

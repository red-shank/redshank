...
export declare type ElementType = 'default' | 'success' | 'info' | 'warning' | 'error';
export declare type MessageType = 'default' | 'shadow';
...
export declare type ElementListType = {
    closable: boolean;
...
export declare type MessageOptions = Partial<Omit<MessageProps, 'internalType' | 'content'>> & {
    closable?: boolean;
    duration?: number;
    key?: any;
    onPress?: () => void;

...
export declare type RadioGroupProps = Partial<Pick<RadioButtonProps, 'backgroundColors' | 'labelColors' | 'value' | 'size' | 'sx'>> & {
    options: Pick<RadioButtonProps, 'value' | 'label' | 'startAdornment' | 'endAdornment'>[];

...
const Footer = ({ children, Component = View, withBackground, isAbsolute = false, right, bottom = 0, left = 0, background = isAbsolute ? 'card' : undefined, style = {}, ...restProps }) => {
    ...
    return (<>
      <Component activeOpacity={activeOpacity} style={StyleSheet.flatten([
            styles.wrapper,
            {
                zIndex: zIndices['2'],

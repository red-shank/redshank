...
export declare type KeyboardType = 'password' | 'default' | 'number-pad' | 'decimal-pad' | 'numeric' | 'email-address' | 'phone-pad' | 'url';
export declare type KeyboardTypeIOS = 'ascii-capable' | 'numbers-and-punctuation' | 'name-phone-pad' | 'twitter' | 'web-search';
export declare type KeyboardTypeAndroid = 'visible-password';
export declare type InputTypes = KeyboardType | KeyboardTypeAndroid | KeyboardTypeIOS;

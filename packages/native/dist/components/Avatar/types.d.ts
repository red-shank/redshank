...
export declare type AvatarIcon = Omit<IconObject, 'iconStyle'>;
...
export interface AvatarGroupProps extends Pick<AvatarProps, 'size' | 'type' | 'textColor' | 'backgroundColor' | 'borderColor' | 'bordered' | 'innerBorderColor' | 'showCountText' | 'imageProps' | 'textStyle'> {

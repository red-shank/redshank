...
export function getListYears(year = now.year()) {
    ...
    if (!newYear.isValid()) {
        throw new Error(`${year} is no valid number please insert a valid year, e.g. 2021`);
    }
...
export const getWeeksInMonth = (startMonth, endMonth) => {
...
export const getWeekOfMonthFromDay = (day, recoil = 2) => {

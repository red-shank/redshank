...
function CalendarLayout({ renderCalendar }) {
    ...
    return (<View style={StyleSheet.flatten([styles.wrapper])}>
      <Animated.View style={StyleSheet.flatten([
        ...
        <Component bounces={false} showsVerticalScrollIndicator={false} showsHorizontalScrollIndicator={false}>
          {renderCalendar}
